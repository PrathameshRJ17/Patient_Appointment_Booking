...
var AuthService = class _AuthService {
  http;
  base = "http://patientappointmentbooking.runasp.net/api/users";
  constructor(http) {
    this.http = http;
  }
  register(payload) {
    ...
    const url = role === UserRole.Patient || role == null ? `${this.base}/register/patient` : `${this.base}/register/professional`;
  ...
  buildRegisterBody(payload) {
    ...
    if (payload.qualification)
      body["qualification"] = payload.qualification;
    if (payload.experienceYears != null)
      body["experienceYears"] = payload.experienceYears;
  ...
  login(payload) {
    return this.http.post(`${this.base}/login`, payload).pipe(tap((res) => {
      localStorage.setItem("token", res.token);
      localStorage.setItem("role", res.role);
      localStorage.setItem("userId", String(res.userId));
      if (res.staffId != null)
        localStorage.setItem("staffId", String(res.staffId));
...
@angular/router/fesm2022/router.mjs:
   ...
   *)
*/
//# sourceMappingURL=chunk-3GA6IDBR.js.map
